    ...
    <div class="our-aim">
        <div class="aim">
            ...
            <p class="aim-text">Aim of <strong style="color:#141414;">
                ...
                The <strong style="color:#141414;">"Virtual Medical Home"</strong> - Practical Applications of Patient-Centered
                ...
                In this project <strong style="color:#141414;">"Virtual Medical Home"</strong> ,the system allows the patients
